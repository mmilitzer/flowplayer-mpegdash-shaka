...
(function () {
            ...
            var bean = flowplayer.bean,
                ...
                engine = {
                    ...
                    load: function(video)
                    {
                        ...
                        /* Shaka */         
                        shakaPlayer = new shaka.Player(videoTag);
                        ...
                        //var contentProtectionCallback = video.shaka.contentProtectionCallback ? video.shaka.contentProtectionCallback : null,
                        //    source = new shaka.Player.DashVideoSource(video.src, contentProtectionCallback, estimator),
                        var onLoad = typeof video.shaka.onLoad === 'function' ? video.shaka.onLoad : null;

                        if(onLoad) {
                            shakaPlayer.load(video.src).then(function(){onLoad.call(shakaPlayer);});
                        } else {
    ...
    engineImpl.engineName = 'mpegdash-shaka-' + shaka.Player.version;
